    ...
    return (
            ...
            <div className ="task-box align-items-center" > 
                <div> 
                    ...
                    <li className = "task-content" style={{textDecoration: complete ? "line-through" : "", textDecorationColor: "#6B7077", textDecorationThickness: 2, color: complete ? "#6B7077" : "white"}}>{content}</li>
                </div>
